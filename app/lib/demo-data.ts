// VibeMail Glass — demo mailbox (fake data, grounded in the backend Message
// model). Seeds the public `/demo` experience via demo-store.ts, which serves
// these records through the same wire contract the live app consumes.
//
...
export const MESSAGES: Message[] = [
  ...
  {
    id: "m10", gmailId: "m10", threadId: "t10",
  ...
  {
    id: "m11", gmailId: "m11", threadId: "t11",
  ...
  {
    id: "m12", gmailId: "m12", threadId: "t12",
  ...
  {
    id: "m13", gmailId: "m13", threadId: "t13",
  ...
  {
    id: "m14", gmailId: "m14", threadId: "t14",
  ...
  {
    id: "m15", gmailId: "m15", threadId: "t15",
  ...
  {
    id: "m16", gmailId: "m16", threadId: "t16",
